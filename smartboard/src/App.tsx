...
const App = () => {
  ...
  const [smartBoard, setSmartBoard] = useState(undefined as any);
  ...
  useEffect(() => {
    if (insights?.insights) {
      const insightdata:any = insights.insights;
      const updateSmartBoard = new SmartBoard(insights2Board(insightdata) as any);
  ...
  const plotContent = (
    <div className="page">
      <SmartBoardDashboard
        chartList={insights2Board(insights.insights) as any}
